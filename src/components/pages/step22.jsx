...
function Step22() {
  ...
  /* backgroundColor:'red', */
        ...
        >
            <img src="step2title.png" style={{height:'50px',float:'left',marginLeft:'10%',padding:0,display: 'block',opacity:showText,transition:'0.4s ease-in-out'}}></img>
        </div>
        <Box
          component="section"
          sx={{
        ...
        >
          <Stack spacing={1} direction="column" alignItems="center" justifyContent="space-between" style={{opacity:showText,transition:'0.4s ease-in-out'}}>
            ...
            Congratulations on completing the Injection and Reattachment. Click "continue" to proceed to the next step.
          </Typography>
              ...
              <Button
                ...
                >
                  <div style={{color:'white',margin:'0' }} onClick={() => navigate('/step31')}>CONTINUE</div>
                </Button>
